        ...
        <div className="footer">
            <div className="fLists">
                <ul className="fList">
                    ...
                    <li className="fListItem">Kommuns</li>
                    <li className="fListItem">Districts</li>
                    <li className="fListItem">Airports</li>
                    <li className="fListItem">Hotels</li>
                    <li className="fListItem">Tourist Attractions</li>
                </ul>
                <ul className="fList">
                ...
                <ul className="fList">
                    ...
                    <li className="fListItem">Apartment finder</li>
                    <li className="fListItem">Restaurant reservations</li>
                    <li className="fListItem">VenusBostäder.com for Booking Agents</li>
                </ul>
                <ul className="fList">
                    <li className="fListItem">Coronavirus (COVID-19) FAQs</li>
                    <li className="fListItem">About VenusBostäder.com</li>
            ...
            <div className="fText">Copyright 2022 VenusBostäder.com</div>
        </div>
    )
}
